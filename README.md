...
Projekt Idee:
Eine Webanwendung, die wie ein Freundebuch funktioniert und Daten wie Name, Alter, Geburtstag, 
Lieblingsfarbe, Lieblingsessen, Hobbys und Traumjob speichert.

Deadline: 18.01    ---> vorher schon eine dokumentation für die use cases per email verschicken

Präsentation: 19.01
- ~6 min
- keine ppp nötig
- zeigen worum es geht und webseite durchlaufen lassen 
